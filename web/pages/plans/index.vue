      ...
      >
        ...
        >
          ...
          <p class="mt-3 text-muted max-w-xl">
            ...
            <code class="font-mono text-dim">.cutlist</code> export and a photo
            or two — the rest is on us.
          </p>
          ...
          >
            ...
            >
              <span class="absolute top-3 right-3 text-xs font-mono text-dim"
                >01</span
              >
              <UIcon name="i-lucide-package" class="w-5 h-5 text-teal-400" />
            ...
            >
              <span class="absolute top-3 right-3 text-xs font-mono text-dim"
                >03</span
              >
              <UIcon name="i-lucide-sparkles" class="w-5 h-5 text-teal-400" />
              <p class="mt-3 text-body font-semibold">Ship</p>
              <p class="mt-1 text-sm text-muted">
                We review, polish, and publish. Your name goes on the card — and
                the world gets to build it.
              </p>
            </li>
          </ol>
