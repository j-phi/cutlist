            ...
            >
              ...
              <template #onshape-body>
                <div class="space-y-3 text-sm text-muted leading-relaxed">
                  <p>
                    <strong class="text-body">Onshape</strong> exports natively
                    to
                  ...
                  <ol class="space-y-2 list-decimal list-inside">
                    <li>
                      ...
                      <strong class="text-body"
                        >unique appearance colour</strong
                      >
                      to each material &mdash; e.g. oak parts one colour,
                      plywood another.
                    </li>
                    <li>
                      Go to
                      <strong class="text-body">File &rarr; Export</strong>, set
                      format to <span class="font-mono text-dim">GLTF</span>,
                      and download.
                    </li>
                    <li>
                      Drag the
                      <span class="font-mono text-dim">.gltf</span> file into
                      Cutlist Studio, or click
                      <strong class="text-body">Import Model</strong> inside
                      your project.
                    </li>
                  </ol>
                  <img
                ...
                <div class="space-y-3 text-sm text-muted leading-relaxed">
                  ...
                  <ol class="space-y-2 list-decimal list-inside">
                    <li>
                      ...
                      <strong class="text-body">separate component</strong>.
                      Apply a different material/colour to each wood type.
                    </li>
                    <li>
                      Go to
                      <strong class="text-body"
                        >File &rarr; Export &rarr; 3D Model</strong
                      >, choose
                      <span class="font-mono text-dim">COLLADA (.dae)</span>,
                      and save.
                    </li>
                    <li>
                      Drag the
                      <span class="font-mono text-dim">.dae</span> file into
                      Cutlist Studio, or click
                      <strong class="text-body">Import Model</strong> inside
                      your project.
                    </li>
              ...
              <template #other-body>
                <div class="space-y-3 text-sm text-muted leading-relaxed">
                  <p>
                    ...
                    <strong class="text-body">COLLADA (.dae)</strong> will work.
                    This includes:
                  </p>
                  <ul class="space-y-1.5 ml-4 list-disc">
                    <li>
                      <strong class="text-body">Fusion 360</strong> &mdash;
                      export as GLTF or use a COLLADA exporter
                    </li>
                    <li>
                      <strong class="text-body">Blender</strong> &mdash; File
                      &rarr; Export &rarr; glTF 2.0
                    </li>
                    <li>
                      <strong class="text-body">FreeCAD</strong> &mdash; export
                      as GLTF via the Mesh workbench
                    </li>
                    <li>
                      <strong class="text-body">SolidWorks</strong> &mdash;
                      export as COLLADA or use a GLTF plugin
                    </li>
                  </ul>
                  <p>
                    The key: assign
                    <strong class="text-body"
                      >distinct colours per material</strong
                    >
              ...
              <template #manual-body>
                <div class="space-y-3 text-sm text-muted leading-relaxed">
                  <p>
                    ...
                    <strong class="text-body">Add Part Manually</strong> to
                    enter each piece with its dimensions, quantity, and
                    material.
                  </p>
                  <p>
                    You can also mix &mdash; import a model for most parts and
                    add a few extras by hand.
                  </p>
                </div>
              </template>
            </UAccordion>
