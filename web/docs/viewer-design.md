...
| 07   | Annotations framework                      | `web/composables/useAnnotations.ts`, `useAnnotationAuthor.ts`, `web/lib/viewer/modules/AnnotationProjector.ts`, `LeaderManager.ts`, `web/components/viewer/AnnotationLabels.vue` |
...
| 09   | Linear dimension annotation                | `web/lib/viewer/annotations/dimension.ts`, `web/components/viewer/DimensionLabel*`, dimension hooks in `AnnotationProjector.ts`                                                  |
